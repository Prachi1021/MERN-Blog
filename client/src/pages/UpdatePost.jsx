...
export default function UpdatePost() {
  ...
  return (
      <div className='min-h-screen p-3  max-w-3xl mx-auto'>
          <h1 className='my-7 text-3xl font-semibold text-center '>Update Post</h1>
          <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
              ...
              <ReactQuill value={formData.content} theme="snow" placeholder='Write something...' className='h-72 mb-12' required onChange={(value) => {
