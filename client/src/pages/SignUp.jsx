      ...
      <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5'>
        ...
        <div className='flex-1'>
          ...
          <p className='mt-5 text-sm'>
            This is a demo project. You can sign-up using your email and password or with google.
          </p>
        ...
        <div className='flex-1'>
          ...
          <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <TextInput type='text' placeholder='Username' id='username' //to get info for submitting the form 
            ...
            <div>
              ...
              <TextInput type='password' placeholder='Password' id='password' //to get info for submitting the form
                onChange={handleChange} />
            </div>
